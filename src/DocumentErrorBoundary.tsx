    ...
    return (
      <div className="review-error" role="alert">
        <div>
          ...
          <p>Your document buffer is still available. Open Source to continue editing or save it.</p>
          <button className="toolbar-button" onClick={this.props.onRequestSource}>Open Source</button>

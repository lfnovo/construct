...
| [06 — Stateless OKF linter](06-okf-linter.md) | Proposed | How should agents and CI validate an OKF bundle on demand without persisting state? | RFC 01 and safe Markdown discovery |

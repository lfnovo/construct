...
| [06 — Stateless OKF linter](06-okf-linter.md) | CLI, Health, and release pipeline implemented; first tagged candidate pending | How should agents and CI validate an OKF bundle on demand without persisting state? | RFC 01 and safe Markdown discovery |
